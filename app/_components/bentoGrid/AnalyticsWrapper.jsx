...
// _components/bentoGrid/AnalyticsWrapper.jsx 수정
...
export const AnalyticsWrapper = async () => {
  try {
    ...
    return <Analytics totalUsers={totalAccumulatedUsers} todayUsers={networkTodayUsers} chartData={chartData} />;
  } catch (error) {
    console.error(error);
    return <div className="p-5 text-[10px] font-black opacity-50 uppercase tracking-widest">Network Stats Offline</div>;
  }
};