  ...
  return ReactDOM.createPortal(
    ...
    >
      <div className="relative group animate-in fade-in zoom-in-95 slide-in-from-left-2 duration-200">
          ...
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-2">
              ...
              <div className="relative">
                ...
                <span className={`absolute inset-0 w-2 h-2 rounded-full ${accentColor} animate-ping opacity-40`} />
              </div>
        ...
        <div className="absolute top-1/2 -left-1.5 -translate-y-1/2 w-3 h-3 rotate-45 
