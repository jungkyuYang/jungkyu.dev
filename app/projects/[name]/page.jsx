import ProjectPdfSection from './ProjectPdfSection';

// 프로젝트 데이터를 상수로 분리 (컴포넌트 외부)
const PROJECT_INFO = {
  "4yclinghomerun-client": {
    title: "KTwiz 홈페이지 UI/UX 개선 프로젝트",
    description: "사용자 경험(UX) 중심의 인터페이스 재설계와 실시간 경기 데이터 시각화를 통해 서비스 접근성을 극대화한 프로젝트입니다.",
  },
  "toy-project3-team1": {
    title: "영상 공유 커뮤니티 모바일 플랫폼",
    description: "FSD(Feature-Sliced Design) 아키텍처를 적용하여 확장성을 확보하고, Supabase를 활용한 실시간 데이터 처리와 Skeleton UI를 통한 LCP 성능 최적화에 집중한 모바일 커뮤니티 플랫폼입니다.",
  },
};
